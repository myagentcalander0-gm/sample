"""Sidebar: session, tabs for Upload (process file) and Chat."""
from __future__ import annotations

import streamlit as st

from datastore import KEY_SELECTED_ID, KEY_SESSION_KEY, KEY_UPLOADS
...
def render_sidebar() -> None:
    ...
    with st.sidebar:
        ...
        render_health_status(st.sidebar)
        st.caption(f"Session: `{st.session_state[KEY_SESSION_KEY]}` · Files in this session only.")
